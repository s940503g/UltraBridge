...
DeviceTemplate.prototype.FourInOneSensor = function () {
    ...
    contact_service.addCharacteristic(Characteristic.StatusLowBattery).on('get', low_battery_getter);
    ...
    temperature_service.addCharacteristic(Characteristic.StatusLowBattery).on('get', low_battery_getter);
    ...
    light_service.addCharacteristic(Characteristic.StatusLowBattery).on('get', low_battery_getter);
    ...
    humidity_service.addCharacteristic(Characteristic.StatusLowBattery).on('get', low_battery_getter);
