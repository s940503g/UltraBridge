...
DeviceTemplate.prototype.FourInOneSensor = function () {
    ...
    contact_service.getCharacteristic(Characteristic.BatteryLevel).on('get', battery_getter);
    ...
    temperature_service.getCharacteristic(Characteristic.BatteryLevel).on('get', battery_getter);
    ...
    light_service.getCharacteristic(Characteristic.BatteryLevel).on('get', battery_getter);
    ...
    humidity_service.getCharacteristic(Characteristic.BatteryLevel).on('get', battery_getter);
