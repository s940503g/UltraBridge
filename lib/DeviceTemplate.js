...
util.inherits(DeviceTemplate, events.EventEmitter);
...
DeviceTemplate.prototype.setAutoUpdate = function (updateFn, updateTimer) {
...
DeviceTemplate.prototype.stopAutoUpdate = function () {
    auto_update_debug(this.name + ' stop auto updating.');
    clearInterval(this.updater);
    this.updater = undefined;
};

DeviceTemplate.prototype.startAutoUpdate = function () {
...
DeviceTemplate.prototype.resetAutoUpdate = function (option) {
    this.stopAutoUpdate();
...
DeviceTemplate.prototype.remove = function () {
    clearInterval(this.updater);
...
DeviceTemplate.prototype.WallSwitch = function () {
    ...
    for (let instance of instances) {
        ...
        this.setAutoUpdate(updater, 5 * 1000);
...
DeviceTemplate.prototype.WirelessElectronicDeadboltDoorLock = function () {
    /* Same to MiLock totally */

    return this.MiLock();
};

DeviceTemplate.prototype.ZW4102CurtainControlModule = function () {
...
DeviceTemplate.prototype.ColourLed = function () {
...
DeviceTemplate.prototype.FourInOneMotoionSensor = function () {
    let name = this.name;
