 ...
 *
 * */
Gateway.prototype.addValueSetter = function (accessory, node, value) {
	let gateway = this;
}
Gateway.prototype.addValueGetter = function (accessory, node, value) {
	let gateway = this;

}
Gateway.prototype.addValueMontitor = function (accessory, node, value) {
	let gateway = this;
...
Gateway.prototype._bridgeLightDimmer = function (node) {	
	...
	node.value.forEach(function (value) {
		switch (value.label) {
			case "Level":
				operater.LightBulb.Brightness(node, value);
				break;
			case "Bright":
				operater.LighBulb.Brightness(node, value);
				break;
		}
	})
...
/*
node.value.forEach(function (value) {
	let operater = Operater(this, accessory);
	switch(value.label) {
		case "Level":
			operater.lightbulb.Brightness(node, value);
		case "Bright":
...
/* parse node and decide how to present */
Operater.prototype.Lightbub = function (node, value) {
